...
public class PendingActivity extends ListActivity {
	...
	class LoadPending extends AsyncTask<Void, Void, Integer> {
		...
		protected void onPreExecute() {
			...
			super.onPreExecute();
			prg = new ProgressDialog(PendingActivity.this);
		...
		protected void onPostExecute(Integer error_num) {
			...
			if (error_num == 2) {
				...
				Toast.makeText(getApplicationContext(),
						"There are no pending assignments", Toast.LENGTH_LONG)
						.show();
			}

			ListAdapter adapter = new SimpleAdapter(PendingActivity.this,
	...
	private void LoadAllInPending(String array) {
