...
public class DoneActivity extends ListActivity {
	 ...
	 * */
	class LoadDone extends AsyncTask<Void, Void, Integer> {

		@Override
		protected void onPreExecute() {

			super.onPreExecute();
			prg = new ProgressDialog(DoneActivity.this);
		...
		protected void onPostExecute(Integer error_num) {
			...
			ListAdapter adapter = new SimpleAdapter(DoneActivity.this,
