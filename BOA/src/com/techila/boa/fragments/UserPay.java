...
import com.techila.boa.NewPayReq;
...
public class UserPay extends Fragment implements OnClickListener {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		req_adp = new UserAdapter(getActivity(), RequestList, "userpay");
	...
	public void onClick(View v) {
		// Start activity NewPayReq to send a new request to the admin from the
		// user
		Intent intent = new Intent(getActivity(), NewPayReq.class);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == 1) {
			...
			req_adp.onActivityResult(requestCode, resultCode, data);
		}
	}
